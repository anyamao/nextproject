...
export default function Signup() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Обновляем store (используем существующие методы)
      useContactStore.getState().setUser(data.user);
      // ❌ Удали эту строку: useContactStore.getState().setIsAuthenticated(true);
