...
export default function ChatSidebar({
  ...
  if (pathname == "/tutor")
    ...
    return (
      <div
        className={`w-[250px] z-20 flex flex-col fixed   ${aisidebarState ? "bg-white border-r  border-gray-200 h-[900px] " : " h-[50px] mt-[10px] "} `}
      >
        <div
          className={`p-[15px] ${!aisidebarState ? " w-[80px] mt-[5px] ml-[20px] bg-purple-500 rounded-full h-[30px]" : " bg-white"}  flex items-center  justify-center`}
        >
          <button
            onClick={onNewChat}
            className={` ${aisidebarState ? "w-[115px]  hover:bg-purple-400 bg-purple-500 text-white " : "w-[25px] bg-none text-purple-500 "}  h-[25px] pointer  rounded-xl smaller-text font-medium transition-colors flex items-center justify-center `}
