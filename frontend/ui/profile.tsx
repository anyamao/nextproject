  ...
  return (
    <main className="relative z-70">
      {profilenavigationState && (
        <div className="cursor-pointer p-[15px]  bg-white z-80 border-[1px] border-gray-300 w-[250px] h-[70px] fixed  right-0 top-0 mt-[60px] mr-[10px] sm:mt-[70px] shadow-md flex flex-col items-center text-black   rounded-xl ">
