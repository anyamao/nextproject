...
export default async function Home() {
  return (
    <div className="flex-1 flex justify-center  min-w-full min-h-full relative bg-gray-100 ">
      <div className="text-wrap mt-[40px] md:h-[700px] h-[880px] flex flex-col  text-[30px] font-semibold w-[70%]">
        ...
        <p className="bg-purple-200 text-[20px] mt-[20px]">
          {" "}
        ...
        <img
          src="/people.png"
          className=" md:ml-[60%] ml-[15%]   w-[250px] h-[250px]"
        />
      </div>
    </div>
  );
